<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="E_Login.aspx.vb" Inherits="EMS_1.E_Login" %>
    ...
    <form id="form1" runat="server">
        <div class="login-container">
            ...
            <div class="input-group">
                ...
                <asp:TextBox ID="txt_unm" runat="server" placeholder="Username" CssClass="input-field"  oninput="validateNameInput(event)"></asp:TextBox>
            </div>
            <div class="input-group">
            ...
            <div class="form-footer">
                ...
                <label for="chkRemember">Remember for 30 days</label>
                <a href="E_ForgetPassword.aspx">Forgot password?</a>
            </div>
